...
def Economic_Green(request):
   ...
   # connection.close()
    return render(request, 'green.html',{'data':rows}) 

def Education_Green(request):
    cursor = connection.cursor()
